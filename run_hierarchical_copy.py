...
def run_hierarchical():
    ...
    for k in range(K):
        ...
        final_df.to_csv("./epoch_results/results_df.csv")
        np.save("./epoch_results/neuron_label_counts.npy",
                np.array(n_labels_k, dtype=object))
        np.save("./epoch_results/neuron_image_counts.npy",
                np.array(n_img_k, dtype=object))
        np.save("./epoch_results/labels.npy",
